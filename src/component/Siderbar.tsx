...
function Siderbar() {
  ...
  return (
    <div className="lg:hidden">
      <button data-drawer-target="separator-sidebar" data-drawer-toggle="separator-sidebar" aria-controls="separator-sidebar" type="button" className="text-white absolute  top-2 right-2" onClick={handleSideBar}>
        <span className="sr-only">Open sidebar</span>
        {sideBar === '-translate-x-full'? <AlignJustify className="text-white lg:hidden" />: <X className="text-white lg:hidden" /> }
       
      </button>
      <aside id="separator-sidebar" className={`fixed top-0 left-0 z-40 w-64 h-screen transition-transform ${sideBar}  sm:translate-x-0`} aria-label="Sidebar">
        <div className="h-full px-3 py-4 overflow-y-auto bg-black/40 backdrop-blur-lg">
