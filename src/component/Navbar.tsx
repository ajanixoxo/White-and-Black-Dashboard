...
function Navbar() {
  return (
    <div className="fixed top-5 left-[35%] flex justify-center items-center">
        <nav className="border hidden lg:flex justify-center items-center border-[#161616] p-2 w-max bg-black/40 backdrop-blur-lg rounded-3xl px-4">
            <ul className="text-white flex justify-between items-center gap-20">
                <li className="text-[#A0A0A0] font-semibold cursor-pointer border border-[#292929] p-2 rounded-3xl px-4 hover:bg-[#d9d8d8] hover:text-[#292929] ease-in-out transition">Product</li>
